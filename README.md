...
![preview](https://github.com/luxutils/livewire-calendar/raw/3.x/preview.gif)
...
```bash
composer require luxutils/livewire-calendar
```
...
![example](https://github.com/luxutils/livewire-calendar/raw/3.x/example.png)
...
- [Saulius Kazokas](https://github.com/saulens22)
